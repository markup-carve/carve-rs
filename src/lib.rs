...
pub use extensions::{
    Autolink, AutolinkOptions, ColorSwatch, ContentMode, Details, ExternalLinks,
    ExternalLinksOptions, FencedRender, FencedRenderOptions, Glossary, HeadingPermalinks,
    HeadingPermalinksOptions, Index, ListTable, ListType, MathBlock, MathBlockOptions, Position,
    Spoiler, TabNormalize, TableOfContents, TableOfContentsOptions, UrlGenerator, Wikilinks,
    WikilinksOptions,
};
