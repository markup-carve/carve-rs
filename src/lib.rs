...
pub use extensions::{
    ...
    HeadingLevelShift, HeadingLevelShiftOptions, HeadingNumbers, HeadingNumbersOptions,
    HeadingPermalinks, HeadingPermalinksOptions, ImgFence, Index, ListTable, ListType, MathBlock,
