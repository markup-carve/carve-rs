...
pub use extensions::{
    ...
    FencedRender, FencedRenderOptions, Glossary, HeadingPermalinks, HeadingPermalinksOptions,
    Index, ListTable, ListType, MathBlock, MathBlockOptions, Position, Spoiler, TabNormalize,
