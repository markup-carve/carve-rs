# Changelog archive: 0.1.5 and earlier

Released entries moved out of [CHANGELOG.md](CHANGELOG.md) to keep the live file
short. Nothing here changed in the move.
