...
fn explicit_header_and_footer_rows_partition_pipe_tables() {
    ...
    assert!(html.contains("<thead><tr><th scope=\"col\">A</th><th scope=\"col\">B</th></tr><tr><th scope=\"col\">C</th><th scope=\"col\">D</th></tr></thead>"));
    assert!(html.contains("<tbody>\n    <tr><td>E</td><td>F</td></tr>\n  </tbody>"));
    assert!(html.contains("<tfoot><tr><td>G</td><td>H</td></tr></tfoot>"));
